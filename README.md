...
- Registers positioned text fragments in a coordinate map keyed by their unrounded X/Y placement points, then uses a `Set` of hit coordinate keys during outline extraction so duplicate hits are not emitted.
