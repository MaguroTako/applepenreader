...
7. Check **検出したテキスト** in the always-visible left panel if you want to confirm all text fragments found on the visible page in one vertical column with unrounded placement X/Y points beside each text item.
