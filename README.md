...
- Extracts positioned text fragments whose deduplicated placement point touches the outline.
- Shows the text detected on the visible PDF page below the extraction result as a single vertical column of detected fragments, with each fragment's deduplicated placement X/Y point beside the text.
